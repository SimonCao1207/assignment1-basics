...
from cs336_basics.model import FFN, Embedding, Linear, RMSNorm, RoPE, softmax
...
def run_swiglu(
    ...
    """
    swiglu = FFN(d_model=d_model, d_ff=d_ff, device=w1_weight.device, dtype=w1_weight.dtype)
...
def run_rope(
    ...
    """
    rope_layer = RoPE(theta=theta, d_k=d_k, max_seq_len=max_seq_len, device=in_query_or_key.device)
